...
export default function Home({ navigate }) {
  ...
  // Bento items — first item spans 2 cols (featured)
  const bentoItems = [
    {
      id: 'Introduction',
      number: '01',
    ...
    <div className="page-container animate-fade-in">
      ...
      <div className="home-hero">
        ...
        <div className="hero-image-container">
          <img src={etcBuildingImg} alt="ETC Building" className="hero-image" />
        </div>
        ...
        {bentoItems.map((item) => (
          ...
          >
            ...
            <div className="bento-top">
              <span className="bento-number">{item.number}</span>
            ...
            {/* Arrow */}
            <svg className="bento-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
